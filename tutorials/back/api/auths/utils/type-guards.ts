...
import { NewDrink, NewPizza, PotentialUser } from "../types";
...
const isPotentialUser = (body: unknown): body is PotentialUser => {
  if (!body || typeof body !== "object") return false;
...
export { isString, isNumber, isNewPizza, isNewDrink, isPartialNewDrink, isPotentialUser };
